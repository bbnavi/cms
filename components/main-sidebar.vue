...
<style lang="scss">
.main-sidebar {
  @apply relative z-50 xl:fixed top-0 left-0;
  @apply max-h-screen p-6 xl:p-8 w-full;
  @apply xl:h-screen xl:w-80 xl:p-0;
  @apply bg-white shadow;

  > div {
    @apply flex flex-row justify-between max-h-screen mx-auto;
    @apply xl:justify-start xl:flex-col xl:h-screen xl:mx-auto;
  }
}

.main-logo {
  @apply xl:px-8 xl:pt-8;
}
